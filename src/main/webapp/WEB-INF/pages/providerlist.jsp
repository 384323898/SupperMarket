...
<div class="right">
    ...
    <div class="search">
        <form method="post" action="${pageContext.request.contextPath }/providerList">
            ...
            <span>供应商编号：</span>
            <input name="queryProviderCode" class="input-text"	type="text" value="${queryProviderCode }">
            <span>供应商名称：</span>
            <input name="queryProviderName" class="input-text"	type="text" value="${queryProviderName }">
    ...
    <table class="providerTable" cellpadding="0" cellspacing="0">
        <tr class="firstTr">
            ...
            <th width="5%">地址</th>
            <th width="5%">传真</th>
            <th width="10%">创建者编号</th>
            <th width="10%">创建时间</th>
            <th width="10%">更新时间</th>
            <th width="10%">更新者编号</th>
            <th width="30%">操作</th>
        </tr>
        <c:forEach var="provider" items="${providerList }" varStatus="status">
            <tr>
                ...
                <td>
                    <span>${provider.createdBy}</span>
                </td>
                <td>
                    <span><fmt:formatDate value="${provider.creationDate}" pattern="yyyy-MM-dd"/></span>
                </td>
                <td>
                    <span><fmt:formatDate value="${provider.modifyDate}" pattern="yyyy-MM-dd"/></span>
                </td>
                <td>
                    <span>${provider.modifyBy}</span>
                </td>
                <td>
